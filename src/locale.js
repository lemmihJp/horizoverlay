const locale = {
  ...
  ptBR: {
    ...
    config: {
      ...
      toggleOption5: 'Você',
      toggleOption6: 'Destaque Duração',
  ...
  zhCN: {
    ...
    config: {
      ...
      localeTitle: '模版语言',
      localeOption: [
        { language: '英语', value: 'enUS' },
        { language: '葡萄牙语', value: 'ptBR' },
        { language: '简体中文', value: 'zhCN' },
        { language: '正體中文', value: 'zhHK' },
  ...
  zhHK: {
    ...
    config: {
      ...
      localeTitle: '模版語言',
      localeOption: [
        { language: '英語', value: 'enUS' },
        { language: '葡萄牙語', value: 'ptBR' },
  ...
  frFR: {
    ...
    config: {
      ...
      localeTitle: 'Langage',
      localeOption: [
        { language: 'Anglais', value: 'enUS' },
        { language: 'Portugais', value: 'ptBR' },
  ...
  jaJP: {
    ...
    config: {
      ...
      help: 'すべて自動で保存されます。<br /><strong>右クリック</strong>で設定画面を表示します。',
    },
    setupMode: {
      instructionsTitle: '<strong>Right click anywhere this window to open settings!</strong>',
      instructions:
